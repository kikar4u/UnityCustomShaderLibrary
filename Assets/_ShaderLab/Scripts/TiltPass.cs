...
public class TiltPass : ScriptableRenderPass
{
    ...
    TiltShiftFeature.PassSettings passSettings;
    ...
    static readonly int smoothnessStrenghtProprety = Shader.PropertyToID("_edgeSmoothness");
    // The constructor of the pass. Here you can set any material properties that do not need to be updated on a per-frame basis.
    public TiltPass(TiltShiftFeature.PassSettings passSettings)
    {
        ...
        material.SetFloat(smoothnessStrenghtProprety, passSettings.blurSmoothness);
    }
